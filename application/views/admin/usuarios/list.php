                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($usuario->firma!=""): ?>
                                                <button type="button" class="btn btn-link btn-subir" data-toggle="modal" data-target="#modal-default" value="<?php echo $usuario->id."*".$usuario->firma;?>">Ver</button>
                                            <?php else:?>
                                                <button type="button" class="btn btn-link btn-subir" data-toggle="modal" data-target="#modal-default" value="<?php echo $usuario->id."*".$usuario->firma;?>">Subir</button>
                                            <?php endif ?>
