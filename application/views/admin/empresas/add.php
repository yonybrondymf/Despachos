        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6 col-sm-8 col-xs-12">
                    <form action="<?php echo base_url();?>ingresos/empresas/store" method="POST" enctype="multipart/form-data">
                        ...
                        <?php if ($this->session->userdata("rol") == "1"):?>
                            <div class="form-group">
                                <label for="imagen">Logo de empresa:</label>
                                <input type="file" name="file" class="form-control" id="imagen">
                                <span class="help-block"> Seleccione archivo con extension .jpg y .png</span>
                            </div>
                        <?php endif ?>
