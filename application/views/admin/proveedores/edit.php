        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6 col-sm-8 col-xs-12">
                    <form action="<?php echo base_url();?>ingresos/proveedores/update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="direccion" class="form-control" required="required" value="<?php echo !empty(set_value('direccion')) ? set_value('direccion'):$proveedor->direccion; ?>">
                        </div >
                        <div class="form-group">
                            <label for="">Telefono:</label>
                            <input type="text" name="telefono" class="form-control" value="<?php echo !empty(set_value('telefono')) ? set_value('telefono'):$proveedor->telefono; ?>">
                        </div>
                        <div class="form-group">
                            <label for="">Correo:</label>
                            <input type="text" name="correo" class="form-control" value="<?php echo !empty(set_value('correo')) ? set_value('correo'):$proveedor->correo; ?>">
                        </div>
